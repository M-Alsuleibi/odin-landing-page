# This is a capstone project of CSS-flex section on [The Odin Project](https://www.theodinproject.com/paths) - [Landing Page](https://www.theodinproject.com/lessons/foundations-landing-page). 

For this project you’ll be creating an entire web page from a design we’ll provide for you. If you’ve been following along you should have the skills you need to accomplish this, but it may not be easy!

The design we’re providing you comes in the form of 2 images: one is an image of the complete website, and one has some details about some of the fonts and colors we’ve used.

Do _not_ be afraid to use Google or go back to previous lessons to look something up. **In real life, professional developers use Google constantly for things that they have been doing for years.**
